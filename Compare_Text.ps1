...
$comparison_score_1x2 = $Sample1 -eq $Sample2
$comparison_score_1x3 = $Sample1 -eq $Sample3

Write-Host "1 vs 2 - String Equality: $comparison_score_1x2 | Length difference: $length_score_1x2"
Write-Host "1 vs 3 - String Equality: $comparison_score_1x3 | Length difference: $length_score_1x2"